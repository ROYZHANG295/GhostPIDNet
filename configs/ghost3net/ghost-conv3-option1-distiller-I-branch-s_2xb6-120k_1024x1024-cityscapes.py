...
model = dict(
    ...
    # 改1
    type='PIDNetDistillerIBranchWrapper',  
    ...
    teacher_ckpt='work_dirs/pidnet-best/pidnet-m_2xb6-120k_1024x1024-cityscapes_20230301_143452-f9bcdbf3.pth',
    temperature=2.0,
