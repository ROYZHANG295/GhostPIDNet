...
model = dict(
    ...
    backbone=dict(
        ...
        # init_cfg=dict(type='Pretrained', checkpoint='checkpoints/pidnet-improved_ghost_conv_class_weight_s_2xb6-120k_1024x1024-cityscapes/iter_240000-miou-77.8.pth')
    ),
    decode_head=dict(
        type='PIDHead',
        in_channels=128,
