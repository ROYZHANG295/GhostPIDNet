...
# 1. 指定从 12万轮 的权重开始加载
load_from = 'work_dirs/pidnet-faster-pconv-s_2xb6-240k_1024x1024-cityscapes-runable-weight-class/best_mIoU_iter_228000.pth'
...
default_hooks = dict(
    ...
    checkpoint=dict(
        type='CheckpointHook', 
        save_best='mIoU',  # 确保它会自动保存 mIoU 最高的模型
        by_epoch=False, interval=iters // 120),
