...
# 1. 定义 Teacher 的配置和权重路径 (需要你自己下载好)
# 假设你下载了 PIDNet-L 的权重放在 checkpoints 文件夹
teacher_config_file = 'configs/pidnet/pidnet-l_2xb6-120k_1024x1024-cityscapes.py'
teacher_checkpoint = 'work_dirs/pidnet-best/pidnet-l_2xb6-120k_1024x1024-cityscapes_20230303_114514-0783ca6b.pth'
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            'teacher': dict(lr_mult=0.0, decay_mult=0.0)
        }
    )
)
