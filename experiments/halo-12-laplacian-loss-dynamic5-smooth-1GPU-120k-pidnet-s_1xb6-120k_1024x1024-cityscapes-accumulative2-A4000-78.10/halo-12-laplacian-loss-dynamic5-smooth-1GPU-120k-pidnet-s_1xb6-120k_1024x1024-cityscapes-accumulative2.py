...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=[
            ...
            dict(loss_weight=1.0, type='BoundaryLoss'),
            dict(
                class_weight=[
                    0.8373,
                    0.918,
        ...
        norm_cfg=dict(requires_grad=True, type='BN'),
        num_classes=19,
        type='PIDHeadLaplacianOpt3Dynamic5Smooth'),
...
work_dir = './work_dirs/halo-12-laplacian-loss-dynamic5-smooth-1GPU-120k-pidnet-s_1xb6-120k_1024x1024-cityscapes-accumulative2'
