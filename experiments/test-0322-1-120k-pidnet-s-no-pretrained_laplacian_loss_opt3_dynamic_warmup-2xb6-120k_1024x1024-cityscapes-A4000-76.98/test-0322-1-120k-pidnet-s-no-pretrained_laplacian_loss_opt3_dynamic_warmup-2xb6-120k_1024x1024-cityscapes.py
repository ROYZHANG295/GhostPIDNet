...
model = dict(
    ...
    decode_head=dict(
        ...
        norm_cfg=dict(requires_grad=True, type='SyncBN'),
        num_classes=19,
        type='PIDHeadLaplacianOpt3Dynamic'),
...
work_dir = './work_dirs/test-0322-1-120k-pidnet-s-no-pretrained_laplacian_loss_opt3_dynamic_warmup-2xb6-120k_1024x1024-cityscapes'
