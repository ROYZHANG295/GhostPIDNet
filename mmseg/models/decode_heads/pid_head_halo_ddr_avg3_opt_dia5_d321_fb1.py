...
class PIDHeadHALOSameDDRAvg3OptDia5D321Fb1(BaseDecodeHead):
    """
    ===========================================================================
...
# }
        ...
        # 版本5：消融实验还缺一个 Fixed 5 + 3.0–1.5–1.0 的版本
        schedule = {
            0:         {'dilation': 5, 'dice_w': 3.0, 'fb_w': 1.0},
            t1:        {'dilation': 5, 'dice_w': 3.0, 'fb_w': 1.0},
            t1 + 1:    {'dilation': 5, 'dice_w': 1.5, 'fb_w': 1.0},  # 从 1.0 提高到 1.5
            t2:        {'dilation': 5, 'dice_w': 1.5, 'fb_w': 1.0},
            t2 + 1:    {'dilation': 5, 'dice_w': 1.0, 'fb_w': 1.0},  # 尾段保底 1.0，而不是 0.5
